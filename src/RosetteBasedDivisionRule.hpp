#ifndef ROSETTEBASEDDIVISIONRULE_HPP_
#define ROSETTEBASEDDIVISIONRULE_HPP_
...
class RosetteBasedDivisionRule : public AbstractCentreBasedDivisionRule<ELEMENT_DIM, SPACE_DIM>
{
private:
...
public:
     ...
     * Empty destructor.
     */
    virtual ~RosetteBasedDivisionRule()
    {
    }
...
#endif // ROSETTEBASEDDIVISIONRULE_HPP_
